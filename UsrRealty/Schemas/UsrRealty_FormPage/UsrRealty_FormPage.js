...
define("UsrRealty_FormPage", /**SCHEMA_DEPS*/["@creatio-devkit/common"]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/(sdk)/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "ButtonRunService",
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_hmoobgg_caption)#",
					"color": "warn",
					"disabled": false,
					"size": "medium",
					"iconPosition": "only-text",
			...
			},
			{
				...
				"values": {
					"type": "crt.Button",
					"caption": "#ResourceString(Button_5oys9gc_caption)#",
					"color": "primary",
					"disabled": false,
					"size": "medium",
					"iconPosition": "only-text",
			...
			{
				"operation": "insert",
				"name": "MenuItem_szib7jk",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_szib7jk_caption)#",
					"visible": true,
					"clicked": {
				...
				"parentName": "Button_5oys9gc",
				"propertyName": "menuItems",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "MenuItem_ksym1j5",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_ksym1j5_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_peowfdu;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_nk0bs6n;
					var offerTypeId = "";
					if (offerTypeObject) {
