define("UsrAvgPriceOutputPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"label": "$Resources.Strings.NumberAttribute_0legv9w",
					"labelPosition": "auto",
					"control": "$NumberAttribute_0legv9w",
					"visible": true,
					"readonly": true,
					"placeholder": "",
					"tooltip": ""
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.Input",
					"label": "$Resources.Strings.StringAttribute_ywt6h5t",
					"labelPosition": "auto",
					"control": "$StringAttribute_ywt6h5t",
					"visible": true,
					"readonly": true,
					"placeholder": "",
					"tooltip": "",
				...
				"parentName": "GridContainer_ouyrboy",
				"propertyName": "items",
				"index": 0
			}
		...
		viewModelConfig: /**SCHEMA_VIEW_MODEL_CONFIG*/{
			"attributes": {
				"NumberAttribute_0legv9w": {
					"modelConfig": {
						"path": "PageParameters.AvgPrice"
					}
				},
				"StringAttribute_ywt6h5t": {
					"modelConfig": {
