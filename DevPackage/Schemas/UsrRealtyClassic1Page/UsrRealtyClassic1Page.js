	...
	return {
		...
		methods: {
			...
			onMyButtonClick: function(){
				this.console.log("My button works fine");
			},
			
			getMyButtonEnabledFlag: function(){
				return (this.isAddMode() && !this.get("UsrName"))?  false :  true;
			},
			
			positiveValueValidator:function(value, column){
				var msg = '';
				if(value < 0 ){
					msg = this.get("Resources.Strings.ValueMustBeGteaterThanZero");
				}
				return{
					invalidMessage:msg
				};
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrNameda53b883-946d-4470-a4c4-f02f6bd7e001",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT12503821-c2b1-4d73-ac63-4aca484eed98",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATd6aa85b2-315a-4ae9-a6e5-aeefa15469eb",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP81aa34b7-725c-4e4c-8a64-829658967b74",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRING2fe34c94-1c75-4075-8acb-83ace6785830",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP996bd1d3-30e8-4d48-8cdc-0f9c7f591b22",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
